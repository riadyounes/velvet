          ...
          <div className="mx-auto mb-12 grid max-w-7xl grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {sabores.map((sabor, index) => (
              <div key={index} className="group cursor-pointer text-center">
                <div
                  className={`relative mx-auto mb-6 h-72 w-full max-w-sm overflow-hidden rounded-xl border-4 shadow-lg transition-all duration-300 hover:scale-105 hover:shadow-xl ${sabor.cor}`}
                >
                  {/* Imagem real do bolo */}
                  <img
                    src={sabor.imagem}
